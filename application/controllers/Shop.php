<?php
    ...
    class Shop extends MY_Controller {
        ...
        public function sortby($sort, $page = null)
        {
            ...
            ->paginate($page)
            ->get();
        $data["total_rows"] = $this->shop->where("product.is_avaiable", 1)->count();
        ...
        public function category($category, $page = null){
            ...
            ->paginate($page)
            ->get();
        $data["total_rows"] = $this->shop->where("product.is_avaiable", 1)->where("category.slug", $category)->join("category")->count();
