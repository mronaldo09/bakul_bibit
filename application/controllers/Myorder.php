...
class Myorder extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data["content"]    =
            $this->myorder->where("id_user", $this->id)->orderBy("date", "DESC")->get();
    ...
    public function detail($invoice)
    {
        ...
        $this->myorder->table   = "pengembalian";

        $data["my_return"] = $this->myorder->where("id_orders", $data["order"]->id)->first();
    ...
    public function confirm($invoice)
    {
        ...
        if ($this->myorder->create($data["input"])) {
            ...
            $this->session->set_flashdata("success", "Terimakasih telah melakukan pembayaran, produk akan segera kami proses.");
        } else {
