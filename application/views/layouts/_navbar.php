<nav class="navbar navbar-expand-md navbar-light text-white fixed-top" style="background-color: #f2a154;">
  <div class="container">
    <a class="navbar-brand" href="<?= base_url() ?>"><strong> BAKUL BIBIT LAMPUNG</strong> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url('readarticle') ?>">Artikel <span class="sr-only">(current)</span></a>
        </li>
        ...
        <?php if ($this->session->userdata("role") == "admin") : ?>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-1">
              ...
              <a href="<?= base_url("article") ?>" class="dropdown-item">Artikel</a>
              <a href="<?= base_url("pengembalian") ?>" class="dropdown-item">Pengembalian</a>
            </div>
          </li>
        <?php endif ?>
      </ul>
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="<?= base_url("cart") ?>" class="nav-link"><i class="fas fa-shopping-cart">Cart(<?= getCart() ?>)</i></a>
        </li>
